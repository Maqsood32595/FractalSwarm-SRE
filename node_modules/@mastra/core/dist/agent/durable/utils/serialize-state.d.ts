...
import type { SerializableToolMetadata, SerializableModelConfig, SerializableModelListEntry, SerializableDurableState, SerializableDurableOptions, SerializableModelSettings, SerializableScorersConfig, DurableAgenticWorkflowInput } from '../types.js';
/**
 ...
 * workflow input.
 */
export declare function serializeModelSettings(settings: SerializableModelSettings | Record<string, unknown> | undefined): SerializableModelSettings | undefined;
/**
