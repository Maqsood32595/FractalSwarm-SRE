...
var chunkZ4KN2GTH_cjs = require('./chunk-Z4KN2GTH.cjs');
var chunkAWV2IL46_cjs = require('./chunk-AWV2IL46.cjs');
var chunkYYUDVZJC_cjs = require('./chunk-YYUDVZJC.cjs');
var chunkYIPJLB6J_cjs = require('./chunk-YIPJLB6J.cjs');
var chunkSOQ5KU4X_cjs = require('./chunk-SOQ5KU4X.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkSOQ5KU4X_cjs.createStreamFromGenerateResult(result)
    };
  }
...
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const allGateways = [...customGateways ?? [], ...chunkZ4KN2GTH_cjs.defaultGateways];
    this.#manager = new chunkZ4KN2GTH_cjs.GatewayManager(allGateways);
    this.gateway = this.#manager.findGatewayForModel(normalizedConfig.id);
    this.gatewayId = chunkAWV2IL46_cjs.getGatewayId(this.gateway);
    const gatewayPrefix = chunkZ4KN2GTH_cjs.GatewayManager.getPrefix(this.gatewayId);
    const parsed = chunkYYUDVZJC_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    let apiKey;
    try {
      const parsed = chunkYYUDVZJC_cjs.parseModelRouterId(this.config.routerId, chunkZ4KN2GTH_cjs.GatewayManager.getPrefix(this.gatewayId));
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkYYUDVZJC_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkSOQ5KU4X_cjs.AISDKV5LanguageModel(model);
  ...
  async doStream(options) {
    ...
    const gatewayPrefix = chunkZ4KN2GTH_cjs.GatewayManager.getPrefix(this.gatewayId);
    const parsedModelId = chunkYYUDVZJC_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix);
  ...
  async resolveLanguageModel({
    ...
    if (this.config.url) {
      const modelInstance2 = chunkYIPJLB6J_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
  ...
  resolveOpenAIWebSocketModel({
    ...
    const wsFetch = chunkZ4KN2GTH_cjs.createOpenAIWebSocketFetch({
      url: responsesWebSocket?.url,
      headers: responsesWebSocket?.headers
    });
    const modelInstance = chunkYIPJLB6J_cjs.createOpenAI({
      apiKey,
      baseURL,
      headers,
      fetch: wsFetch
...
function readGatewayStreamTransport(model) {
  return model[chunkYIPJLB6J_cjs.MASTRA_GATEWAY_STREAM_TRANSPORT];
}
...
async function resolveModelConfig(modelConfig, requestContext = new chunkPJIAL3WK_cjs.RequestContext(), mastra) {
  ...
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof AISDKV4LegacyLanguageModel || modelConfig instanceof chunkSOQ5KU4X_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel || modelConfig instanceof AISDKV7LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkSOQ5KU4X_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var VERSION = "2.0.72" ;
var googleErrorDataSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      error: v4.z.object({
...
var googleFailedResponseHandler = chunkYIPJLB6J_cjs.createJsonErrorResponseHandler({
...
var googleGenerativeAIEmbeddingProviderOptions = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      /**
...
var GoogleGenerativeAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const googleOptions = await chunkYIPJLB6J_cjs.parseProviderOptions({
      provider: "google",
      providerOptions,
      schema: googleGenerativeAIEmbeddingProviderOptions
    });
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkYIPJLB6J_cjs.TooManyEmbeddingValuesForCallError({
        provider: this.provider,
        modelId: this.modelId,
    ...
    const mergedHeaders = chunkYIPJLB6J_cjs.combineHeaders(
      await chunkYIPJLB6J_cjs.resolve(this.config.headers),
      headers
    );
    ...
    if (values.length === 1) {
      ...
      const {
        ...
        value: response2,
        rawValue: rawValue2
      } = await chunkYIPJLB6J_cjs.postJsonToApi({
        ...
        successfulResponseHandler: chunkYIPJLB6J_cjs.createJsonResponseHandler(
...
var googleGenerativeAITextEmbeddingResponseSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var googleGenerativeAISingleEmbeddingResponseSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
    ...
    switch (role) {
      case "system": {
        if (!systemMessagesAllowed) {
          throw new chunkYIPJLB6J_cjs.UnsupportedFunctionalityError({
            ...
            case "file": {
              ...
              parts.push(
                part.data instanceof URL ? {
                  ...
                  inlineData: {
                    mimeType: mediaType,
                    data: chunkYIPJLB6J_cjs.convertToBase64(part.data)
                  }
                }
              );
              break;
...
var googleGenerativeAIProviderOptions = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var GoogleGenerativeAILanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a = config.generateId) != null ? _a : chunkYIPJLB6J_cjs.generateId;
  }
  get provider() {
    return this.config.provider;
  }
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkYIPJLB6J_cjs.createJsonResponseHandler(responseSchema),
  ...
  async doStream(options) {
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const headers = chunkYIPJLB6J_cjs.combineHeaders(
      await chunkYIPJLB6J_cjs.resolve(this.config.headers),
      options.headers
    );
    const { responseHeaders, value: response } = await chunkYIPJLB6J_cjs.postJsonToApi({
      url: `${this.config.baseURL}/${getModelPath(
        this.modelId
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkYIPJLB6J_cjs.createEventSourceResponseHandler(chunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
...
var responseSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var chunkSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      candidates: v4.z.array(
        v4.z.object({
...
var codeExecution = chunkYIPJLB6J_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var enterpriseWebSearch = chunkYIPJLB6J_cjs.createProviderDefinedToolFactory({
  id: "google.enterprise_web_search",
  name: "enterprise_web_search",
  inputSchema: chunkYIPJLB6J_cjs.lazySchema(() => chunkYIPJLB6J_cjs.zodSchema(v4.z.object({})))
});
...
var fileSearchArgsSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(fileSearchArgsBaseSchema)
);
var fileSearch = chunkYIPJLB6J_cjs.createProviderDefinedToolFactory({
  id: "google.file_search",
  name: "file_search",
  inputSchema: fileSearchArgsSchema
});
var googleMaps = chunkYIPJLB6J_cjs.createProviderDefinedToolFactory({
...
var googleSearchToolArgsSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(googleSearchToolArgsBaseSchema)
);
var googleSearch = chunkYIPJLB6J_cjs.createProviderDefinedToolFactory({
  id: "google.google_search",
  name: "google_search",
  inputSchema: googleSearchToolArgsSchema
});
var urlContext = chunkYIPJLB6J_cjs.createProviderDefinedToolFactory({
  id: "google.url_context",
  name: "url_context",
  inputSchema: chunkYIPJLB6J_cjs.lazySchema(() => chunkYIPJLB6J_cjs.zodSchema(v4.z.object({})))
});
var vertexRagStore = chunkYIPJLB6J_cjs.createProviderDefinedToolFactory({
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerate(options) {
    ...
    const { responseHeaders, value: response } = await chunkYIPJLB6J_cjs.postJsonToApi({
      ...
      headers: chunkYIPJLB6J_cjs.combineHeaders(await chunkYIPJLB6J_cjs.resolve(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkYIPJLB6J_cjs.createJsonResponseHandler(
...
var googleImageResponseSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var googleImageProviderOptionsSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
function createGoogleGenerativeAI(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunkYIPJLB6J_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://generativelanguage.googleapis.com/v1beta";
  const providerName = (_b = options.name) != null ? _b : "google.generative-ai";
  const getHeaders = () => chunkYIPJLB6J_cjs.withUserAgentSuffix(
    {
      "x-goog-api-key": chunkYIPJLB6J_cjs.loadApiKey({
  ...
  const createChatModel = (modelId) => {
    ...
    return new GoogleGenerativeAILanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: (_a2 = options.generateId) != null ? _a2 : chunkYIPJLB6J_cjs.generateId,
      supportedUrls: () => ({
        "*": [
...
var openaiFailedResponseHandler = chunkYIPJLB6J_cjs.createJsonErrorResponseHandler({
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    type: "image_url",
                    image_url: {
                      url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkYIPJLB6J_cjs.convertToBase64(part.data)}`,
                  ...
                  return {
                    ...
                    file: typeof part.data === "string" && part.data.startsWith("file-") ? { file_id: part.data } : {
                      ...
                      file_data: `data:application/pdf;base64,${chunkYIPJLB6J_cjs.convertToBase64(part.data)}`
                    }
                  };
                } else {
                  throw new chunkYIPJLB6J_cjs.UnsupportedFunctionalityError({
...
var openaiChatResponseSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var openaiChatChunkSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiChatLanguageModelOptions = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a, _b, _c, _d;
    const warnings = [];
    const openaiOptions = (_a = await chunkYIPJLB6J_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      headers: chunkYIPJLB6J_cjs.combineHeaders(this.config.headers(), options.headers),
      body,
    ...
    for (const toolCall of (_a = choice.message.tool_calls) != null ? _a : []) {
      content.push({
        type: "tool-call",
        toolCallId: (_b = toolCall.id) != null ? _b : chunkYIPJLB6J_cjs.generateId(),
    ...
    for (const annotation of (_c = choice.message.annotations) != null ? _c : []) {
      content.push({
        type: "source",
        sourceType: "url",
        id: chunkYIPJLB6J_cjs.generateId(),
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkYIPJLB6J_cjs.postJsonToApi({
      ...
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkYIPJLB6J_cjs.createEventSourceResponseHandler(
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.type != null && toolCallDelta.type !== "function") {
                    throw new chunkYIPJLB6J_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                  ...
                  if (((_o = toolCall2.function) == null ? void 0 : _o.name) != null && ((_p = toolCall2.function) == null ? void 0 : _p.arguments) != null) {
                    ...
                    if (chunkYIPJLB6J_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_q = toolCall2.id) != null ? _q : chunkYIPJLB6J_cjs.generateId(),
                ...
                if (((_v = toolCall.function) == null ? void 0 : _v.name) != null && ((_w = toolCall.function) == null ? void 0 : _w.arguments) != null && chunkYIPJLB6J_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_x = toolCall.id) != null ? _x : chunkYIPJLB6J_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunkYIPJLB6J_cjs.InvalidPromptError({
...
var openaiCompletionResponseSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiCompletionChunkSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiCompletionProviderOptions = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAICompletionLanguageModel = class {
  ...
  async getArgs({
    ...
    const warnings = [];
    const openaiOptions = {
      ...await chunkYIPJLB6J_cjs.parseProviderOptions({
        provider: "openai",
        providerOptions,
...
var openaiEmbeddingProviderOptions = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      /**
...
var openaiTextEmbeddingResponseSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var OpenAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const {
      ...
      headers: chunkYIPJLB6J_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: values,
...
var openaiImageResponseSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      created: v4.z.number().nullish(),
      data: v4.z.array(
...
chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(baseImageModelOptionsObject)
);
var openaiImageModelGenerationOptions = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
...
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    const currentDate = (_c = (_b = (_a = this.config._internal) == null ? void 0 : _a.currentDate) == null ? void 0 : _b.call(_a)) != null ? _c : /* @__PURE__ */ new Date();
    const openaiOptions = (_d = await chunkYIPJLB6J_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
      schema: openaiImageModelGenerationOptions
    })) != null ? _d : {};
    const { value: response, responseHeaders } = await chunkYIPJLB6J_cjs.postJsonToApi({
      url: this.config.url({
...
var codeInterpreterInputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterOutputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      outputs: v4.z.array(
...
var codeInterpreterArgsSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterToolFactory = chunkYIPJLB6J_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var fileSearchArgsSchema2 = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var fileSearchOutputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var fileSearch2 = chunkYIPJLB6J_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.file_search",
  name: "file_search",
  inputSchema: v4.z.object({}),
  outputSchema: fileSearchOutputSchema
});
var imageGenerationArgsSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var imageGenerationInputSchema = chunkYIPJLB6J_cjs.lazySchema(() => chunkYIPJLB6J_cjs.zodSchema(v4.z.object({})));
var imageGenerationOutputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(v4.z.object({ result: v4.z.string() }))
);
var imageGenerationToolFactory = chunkYIPJLB6J_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var localShellInputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      action: v4.z.object({
...
var localShellOutputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(v4.z.object({ output: v4.z.string() }))
);
var localShell = chunkYIPJLB6J_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.local_shell",
  name: "local_shell",
  inputSchema: localShellInputSchema,
  outputSchema: localShellOutputSchema
});
var webSearchArgsSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var webSearchInputSchema = chunkYIPJLB6J_cjs.lazySchema(() => chunkYIPJLB6J_cjs.zodSchema(v4.z.object({})));
var webSearchOutputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var webSearchToolFactory = chunkYIPJLB6J_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var webSearchPreviewArgsSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      searchContextSize: v4.z.enum(["low", "medium", "high"]).optional(),
      userLocation: v4.z.object({
...
var webSearchPreviewInputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(v4.z.object({}))
);
var webSearchPreviewOutputSchema = chunkYIPJLB6J_cjs.lazySchema(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreview = chunkYIPJLB6J_cjs.createProviderDefinedToolFactoryWithOutputSchema({
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    ...part.data instanceof URL ? { image_url: part.data.toString() } : typeof part.data === "string" && isFileId(part.data, fileIdPrefixes) ? { file_id: part.data } : {
                      image_url: `data:${mediaType};base64,${chunkYIPJLB6J_cjs.convertToBase64(part.data)}`
                    },
          ...
          switch (part.type) {
            ...
            case "tool-call": {
              ...
              if (hasLocalShellTool && part.toolName === "local_shell") {
                const parsedInput = await chunkYIPJLB6J_cjs.validateTypes({
                  value: part.input,
            ...
            case "reasoning": {
              const providerOptions = await chunkYIPJLB6J_cjs.parseProviderOptions({
                provider: "openai",
      ...
      case "tool": {
        for (const part of content) {
          ...
          if (hasLocalShellTool && part.toolName === "local_shell" && output.type === "json") {
            const parsedOutput = await chunkYIPJLB6J_cjs.validateTypes({
              value: output.value,
...
var openaiResponsesChunkSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
...
var openaiResponsesResponseSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
...
var openaiResponsesProviderOptionsSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      ...
      case "provider-defined": {
        switch (tool.id) {
          case "openai.file_search": {
            const args = await chunkYIPJLB6J_cjs.validateTypes({
              value: tool.args,
...
var OpenAIResponsesLanguageModel = class {
  ...
  async getArgs({
    ...
    const openaiOptions = await chunkYIPJLB6J_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    if (response.error) {
      throw new chunkYIPJLB6J_cjs.APICallError({
            ...
            for (const annotation of contentPart.annotations) {
              if (annotation.type === "url_citation") {
                content.push({
                  type: "source",
                  sourceType: "url",
                  id: (_f = (_e = (_d = this.config).generateId) == null ? void 0 : _e.call(_d)) != null ? _f : chunkYIPJLB6J_cjs.generateId(),
                  url: annotation.url,
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_i = (_h = (_g = this.config).generateId) == null ? void 0 : _h.call(_g)) != null ? _i : chunkYIPJLB6J_cjs.generateId(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_o = (_n = (_m = this.config).generateId) == null ? void 0 : _n.call(_m)) != null ? _o : chunkYIPJLB6J_cjs.generateId(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = this.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunkYIPJLB6J_cjs.generateId(),
                  mediaType: "application/octet-stream",
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              if (value.annotation.type === "url_citation") {
                controller.enqueue({
                  type: "source",
                  sourceType: "url",
                  id: (_r = (_q = (_p = self.config).generateId) == null ? void 0 : _q.call(_p)) != null ? _r : chunkYIPJLB6J_cjs.generateId(),
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = self.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunkYIPJLB6J_cjs.generateId(),
                  mediaType: "text/plain",
...
var openaiSpeechProviderOptionsSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      instructions: v4.z.string().nullish(),
...
var OpenAISpeechModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: requestBody,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkYIPJLB6J_cjs.createBinaryResponseHandler(),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    return {
...
var openaiTranscriptionResponseSchema = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      text: v4.z.string(),
...
var openAITranscriptionProviderOptions = chunkYIPJLB6J_cjs.lazyValidator(
  () => chunkYIPJLB6J_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAITranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkYIPJLB6J_cjs.convertBase64ToUint8Array(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunkYIPJLB6J_cjs.mediaTypeToExtension(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkYIPJLB6J_cjs.postFormDataToApi({
      url: this.config.url({
...
function createOpenAI2(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunkYIPJLB6J_cjs.withoutTrailingSlash(
    chunkYIPJLB6J_cjs.loadOptionalSetting({
  ...
  const getHeaders = () => chunkYIPJLB6J_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkYIPJLB6J_cjs.loadApiKey({
        apiKey: options.apiKey,
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.providerId === MASTRA_GATEWAY_ID) {
      ...
      this.providerModel = chunkYIPJLB6J_cjs.createOpenAICompatible({
        name: MASTRA_GATEWAY_ID,
        apiKey,
        baseURL: getMastraGatewayBaseUrl(normalizedConfig.url),
        headers: {
          "User-Agent": chunkYIPJLB6J_cjs.MASTRA_USER_AGENT,
      ...
      const registry = chunkAWV2IL46_cjs.GatewayRegistry.getInstance();
...
//# sourceMappingURL=chunk-YK5LWDCV.cjs.map
//# sourceMappingURL=chunk-YK5LWDCV.cjs.map