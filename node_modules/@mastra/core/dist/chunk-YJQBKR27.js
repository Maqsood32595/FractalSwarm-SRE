import { Tool, isVercelTool, isProviderDefinedTool, validateToolInput, getNeedsApprovalFn, validateToolOutput, validateToolSuspendData } from './chunk-N47XSDT2.js';
...
import { MastraFGAPermissions } from './chunk-MWNKNSWP.js';
import { backgroundOverrideZodSchema, backgroundOverrideJsonSchema } from './chunk-H2FEPFZ4.js';
...
var CoreToolBuilder = class extends MastraBase {
  ...
  createExecute(tool, options, logType) {
    ...
    return async (args, execOptions) => {
      ...
      if (fgaProvider) {
        const { getAgentToolFGAResourceId, getMCPToolFGAResourceId, getStandaloneToolFGAResourceId, requireFGA } = await import('./fga-check-URMQZDOH.js');
...
//# sourceMappingURL=chunk-YJQBKR27.js.map
//# sourceMappingURL=chunk-YJQBKR27.js.map