...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-AWV2IL46.cjs', document.baseURI).href)) || "file://");
...
function loadRegistry(useDynamicLoading, customGateways = []) {
  const enabledGatewayIds = getEnabledGatewayIds([
    new chunkYYUDVZJC_cjs.ModelsDevGateway({}),
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-TCHHE7IK.cjs');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-5BWJMPTE.cjs');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-WQ7YQ3RN.cjs');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-EEE2BL5U.cjs');
...
var MastraGateway = class extends chunkYIPJLB6J_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
  }
  ...
  resolveLanguageModel({
    ...
    if (this.config?.customFetch && providerId === "anthropic") {
      return chunkYIPJLB6J_cjs.createAnthropic({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunkYIPJLB6J_cjs.MASTRA_USER_AGENT,
          [chunkYIPJLB6J_cjs.GATEWAY_AUTH_HEADER]: `Bearer ${apiKey}`,
          ...headers
        },
    ...
    if (this.config?.customFetch) {
      return chunkYYUDVZJC_cjs.createOpenRouter({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunkYIPJLB6J_cjs.MASTRA_USER_AGENT,
...
//# sourceMappingURL=chunk-AWV2IL46.cjs.map
//# sourceMappingURL=chunk-AWV2IL46.cjs.map