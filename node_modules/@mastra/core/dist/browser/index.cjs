...
2. Remove profile/executablePath to connect to the existing browser via CDP`
  ...
  getInputProcessors(configuredProcessors = []) {
    const hasProcessor = configuredProcessors.some(
      (p) => !chunkD3YQMZ7V_cjs.isProcessorWorkflow(p) && "id" in p && p.id === "browser-context"
    );
...
function createBrowserRecordingTools(browser, options) {
  ...
  return {
    browser_record: chunkHISQ2TWD_cjs.createTool({
      id: "browser_record",
    ...
    browser_record_caption: chunkHISQ2TWD_cjs.createTool({
...
Object.defineProperty(exports, "BrowserCliHandler", {
  enumerable: true,
  get: function () { return chunkK5JBD726_cjs.BrowserCliHandler; }
});
Object.defineProperty(exports, "browserCliHandler", {
  enumerable: true,
  get: function () { return chunkK5JBD726_cjs.browserCliHandler; }
