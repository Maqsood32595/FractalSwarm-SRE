import { ModelsDevGateway, createOpenRouter } from './chunk-GHDHOLZS.js';
import { NetlifyGateway } from './chunk-72T5FXF6.js';
import { MastraModelGateway, createAnthropic, MASTRA_USER_AGENT, GATEWAY_AUTH_HEADER } from './chunk-LDPX2RFL.js';
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-4I5LIW6O.js');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-2ZULTSND.js');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-M2ADT26G.js');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-H6KA55W3.js');
...
//# sourceMappingURL=chunk-MDDN553P.js.map
//# sourceMappingURL=chunk-MDDN553P.js.map