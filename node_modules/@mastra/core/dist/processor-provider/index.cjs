...
var unicodeNormalizerProvider = {
  ...
  createProcessor(config) {
    return new chunkK5JBD726_cjs.UnicodeNormalizer(config);
  }
};
var tokenLimiterProvider = {
  ...
  createProcessor(config) {
    return new chunkK5JBD726_cjs.TokenLimiterProcessor(
      config
    );
  }
};
var toolCallFilterProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkK5JBD726_cjs.ToolCallFilter(config);
  }
};
var batchPartsProvider = {
  ...
  createProcessor(config) {
    return new chunkK5JBD726_cjs.BatchPartsProcessor(config);
  }
};
var moderationProvider = {
  ...
  createProcessor(config) {
    return new chunkK5JBD726_cjs.ModerationProcessor(config);
  }
};
var promptInjectionDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkK5JBD726_cjs.PromptInjectionDetector(config);
  }
};
var piiDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkK5JBD726_cjs.PIIDetector(config);
  }
};
var languageDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkK5JBD726_cjs.LanguageDetector(config);
  }
};
var systemPromptScrubberProvider = {
  ...
  createProcessor(config) {
    return new chunkK5JBD726_cjs.SystemPromptScrubber(config);
  }
};
