...
var getTraceStep = chunkK5JBD726_cjs.createStep2({
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkYX5KZH6G_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkK5JBD726_cjs.createWorkflow2({
