...
function buildBackgroundTaskWorkflow(manager) {
  const runAttemptStep = chunkK5JBD726_cjs.createStep2({
    id: "run-attempt",
  ...
  const classifyOutcomeStep = chunkK5JBD726_cjs.createStep2({
    id: "classify-outcome",
  ...
  const attemptBodyWorkflow = chunkK5JBD726_cjs.createWorkflow2({
    id: `${chunkERDO25O4_cjs.BACKGROUND_TASK_WORKFLOW_ID}__attempt`,
    inputSchema: bodyIOSchema,
    outputSchema: bodyOutputSchema,
  ...
  return chunkK5JBD726_cjs.createWorkflow2({
    id: chunkERDO25O4_cjs.BACKGROUND_TASK_WORKFLOW_ID,
    inputSchema,
    outputSchema: bodyOutputSchema,
...
Object.defineProperty(exports, "BACKGROUND_TASK_WORKFLOW_ID", {
  enumerable: true,
  get: function () { return chunkERDO25O4_cjs.BACKGROUND_TASK_WORKFLOW_ID; }
});
exports.buildBackgroundTaskWorkflow = buildBackgroundTaskWorkflow;
//# sourceMappingURL=workflow-DPSJQDP6.cjs.map
//# sourceMappingURL=workflow-DPSJQDP6.cjs.map