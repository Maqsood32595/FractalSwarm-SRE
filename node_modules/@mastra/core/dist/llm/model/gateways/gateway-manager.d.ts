import type { GatewayAuthResult, MastraModelGatewayInterface, ProviderConfig } from './base.js';
/**
...
export declare class GatewayManager {
     ...
     */
    resolveAuth(routerId: string): Promise<GatewayAuthResult>;
    /** Convenience: whether auth is available for a model. Never throws. */
    hasAuth(routerId: string): Promise<boolean>;
    /**
     ...
     */
    listAvailableModels(): Promise<GatewayModel[]>;
